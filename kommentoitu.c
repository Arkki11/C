...
//
#include <stdio.h>
struct opiskelija {	/*structiin tallennetaan syotettavat tiedot*/
...
int main() {
   /* FILE *kanta;
    ...
    do {	/*ohjelma kysyy kayttajalta mita han haluaa tehda, kysymalla funktiota vastaavan numeron*/
        ...
        //Nimea valiaikainen tiedeosto tiedostoksi.
         /* {
            ...
            rename("tiedosto", "tiedosto.bak");	/*ohjelma luo varmuuskopion paatiedostosta*/
...
int lisaa_oppilas(struct opiskelija rekisteri[30]) {	/*tassa funktiossa kysytaan kuinka monen opiskelijan tiedot halutaan lisata, ja sitten lisataan ne*/
...
int arvioi_tehtava(struct opiskelija rekisteri[30])
{	/*tassa funktiossa kysytaan mihin tehtavaan halutaan antaa arvosana, lisataan arvosana opiskelijalle, jonka jalkeen ohjelma kysyy haluatko antaa arvosanan toiseenkin tehtavaan*/
...
int arvioi_yksi(struct opiskelija rekisteri[30]) { /*tassa funktiossa voi antaa arvosanan yhteen tehtavaan*/
...
void nayta_kaikki (struct opiskelija rekisteri[30]) {	/*tassa funktiossa naytetaan kaikki structiin tallennetut tiedot*/
...
void nayta_oppilas(struct opiskelija rekisteri[30]) {	/*tassa funktiossa naytetaan yhden structiin tallennetun opiskelijan tiedot*/
    int omanum=0;
